 ...
 */
public final class ProfessionalLowRevenuePricePolicy implements PricePolicy {

    private static final Map<ProductType, BigDecimal> PRICES = new EnumMap<>(ProductType.class);
    public static final ProfessionalLowRevenuePricePolicy INSTANCE = new ProfessionalLowRevenuePricePolicy();

    static {
        PRICES.put(ProductType.HIGH_END_PHONE, BigDecimal.valueOf(1150));
        PRICES.put(ProductType.MID_RANGE_PHONE, BigDecimal.valueOf(600));
        PRICES.put(ProductType.LAPTOP, BigDecimal.valueOf(1000));
    }
